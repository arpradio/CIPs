...
| copyright | Object | "copyright": {"master": ["℗ 1985 Sony Records"], "composition": ["© 1985 Marvin Gaye"]} or <br/> "copyright": {"composition": ["Public Domain"], "master": ["℗ 2024 Cool Guy"]} | Included in release within "Album/EP" release_type only when all songs share identical copyright information. Always included in song for track-specific copyright information.|
